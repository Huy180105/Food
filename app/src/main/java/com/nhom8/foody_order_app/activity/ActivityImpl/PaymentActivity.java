...
import com.nhom8.foody_order_app.exception.PhoneNumberException;
...
public class PaymentActivity extends AppCompatActivity {
    ...
    private void referencesComponents() {
        ...
        tvTotalValue.setText(String.format("%s VNÄ", sum));
        ...
        btnThanhToan.setOnClickListener(view -> {
            ...
            // User Notify
            String content = getResources().getString(R.string.information_order_item) + sum + " VNÄ";
