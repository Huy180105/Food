...
import com.nhom8.foody_order_app.components.CartCard;
...
public class ViewOrderActivity extends AppCompatActivity {
    ...
    private void LoadData() {
        tvDate.setText(String.format("+ NgÃ y Äáº·t Sáº£n Pháº©m: %s", order.getDateOfOrder()));
        tvAddress.setText(String.format("+ Äá»‹a Chá»‰ Giao HÃ ng: %s", order.getAddress()));
        tvPrice.setText(String.format("+ Tá»•ng Tiá»n Sáº£n Pháº©m: %s", getRoundPrice(order.getTotalValue())));
        tvStatus.setText(String.format("+ Tráº¡ng ThÃ¡i Giao HÃ ng: %s", order.getStatus()));
