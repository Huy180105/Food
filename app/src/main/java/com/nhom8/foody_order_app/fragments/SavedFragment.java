...
import com.nhom8.foody_order_app.components.FoodSavedCard;
import com.nhom8.foody_order_app.components.RestaurantCard;
                ...
                for (FoodSaved foodSaved : foodSavedArrayList) {
                    ...
                    savedCard.setOnClickListener(view -> {
                        ...
                        try {
                            ...
                            Toast.makeText(getContext(), "KhÃ´ng thá»ƒ hiá»ƒn thá»‹ thÃ´ng tin!", Toast.LENGTH_SHORT).show();
                        }
                    });
