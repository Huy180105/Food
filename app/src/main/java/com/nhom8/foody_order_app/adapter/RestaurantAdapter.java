...
public class RestaurantAdapter extends RecyclerView.Adapter<RestaurantAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RestaurantAdapter.ViewHolder holder, int position) {
        ...
        // hiá»ƒn thá»‹ chi tiáº¿t FragmentCategory
        holder.imageRestaurant.setOnClickListener(v -> {
            Intent intent = new Intent(v.getContext(), CategoryActivity.class);
            // dÃ¹ng putExtra Ä‘á»ƒ Ä‘áº©y Id sang Fragment khÃ¡c cÅ©ng lÃ  cÃ¡ch hay
            intent.putExtra("restaurantId", restaurant.getId());
            v.getContext().startActivity(intent);
        });

        // lÆ°u thÃ´ng tin cá»­a hÃ ng vÃ o danh sÃ¡ch chá»
        holder.btnSavedShop.setOnClickListener(v -> {
            Context context = v.getContext(); // Láº¥y context tá»« View v
